...
function formatExpirationDate(input) {
  const cardExpiration = input.value.replace(/\D/g, "");
  const formattedExpiration = cardExpiration.replace(/(\d{2})/g, "$1/");
  
  input.value = formattedExpiration.replace(/\/$/, "");
}

function formatCVV(input) {
  const cardCVV = input.value.replace(/\D/g, "");
...
export function CartView({
  ...
  const handleFormatCardExpiration = (event) => {
    const cardExpiration = document.getElementById("cc-expiration");
    formatExpirationDate(cardExpiration);
  }

  const handleFormatCVV = (event) => {
    ...
    <div>
      ...
      <div className="container">
              ...
              <div class="row gy-3">
                ...
                <div class="col-md-3">
                  ...
                  <input
                    ...
                    placeholder=""
                    maxlength="5"
                    onInput={handleFormatCardExpiration}
                    required
                  ></input>
        ...
        <footer class="my-5 pt-5 text-body-secondary text-center text-small">
          <p class="mb-1">&copy; 2024–2025 N&N</p>
